...
| Stage/Speaker optimiser | **Heuristic** (small candidate set, weighted score) |
...
* Optimizer evaluates a hand-picked candidate set — it can't discover
  non-obvious geometries.
